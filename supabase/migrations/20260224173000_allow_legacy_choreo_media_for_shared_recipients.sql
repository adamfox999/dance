...
-- Allow accepted share recipients to access legacy choreography media keys
-- that predate routine-scoped media metadata:
--   - choreo-music
--   - choreo-video
-- This keeps owner/guardian behavior unchanged while preserving backward compatibility.
